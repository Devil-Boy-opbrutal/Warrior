...
from LyraMusic.core.call import Lyra, autoend
from LyraMusic.utils.database import (get_client, is_active_chat,
                                       is_autoend)
...
async def auto_leave():
    if config.AUTO_LEAVING_ASSISTANT == str(True):
        while not await asyncio.sleep(
            ...
            from LyraMusic.core.userbot import assistants
