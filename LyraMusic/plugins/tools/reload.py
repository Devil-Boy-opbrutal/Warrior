...
from LyraMusic.utils.database import get_authuser_names, get_cmode
from LyraMusic.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from LyraMusic.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Lyra.stop_stream(message.chat.id)
    except:
        pass
