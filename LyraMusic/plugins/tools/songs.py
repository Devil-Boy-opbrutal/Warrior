...
from LyraMusic.utils.decorators.language import language, languageCB
from LyraMusic.utils.formatters import convert_bytes
from LyraMusic.utils.inline.song import song_markup
...
async def song_helper_cb(client, CallbackQuery, _):
    ...
    if stype == "audio":
        ...
        try:
            ...
            return await CallbackQuery.edit_message_text(_["song_7"])
        keyboard = InlineKeyboard()
        # AVC Formats Only [ LYRA MUSIC BOT ]
